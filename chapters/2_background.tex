...
Using set of equations (2.1) to estimate the latitude and longitude for the reference coordinate point. The final transformation results in applying (2.2) to ECEF physical quantities
