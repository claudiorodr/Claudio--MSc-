...
\acrfull{saam} is novel estimator proposed by \cite{wu2018super}, offers an extremely simplified computation of Davenport’s solution to Wahba’s problem, where the full solution is reduced to a couple of floating point operations, without losing much accuracy, and sparing computational time.
